...
Выводы по этапу: Этап загрузки и верификации успешно завершен. Данные сохранены, их структура и объемы понятны. Код готов к этапу очистки.
...
Выводы по этапу: Найдено 71 дублирующаяся запись.
...
Выводы по этапу: Количество записей в 2025 году выросло на ~20% по сравнению с 2024. Это может быть связано с ростом бизнеса или расширением ассортимента.
...
Что сделано: 5 комплексных визуализаций, охватывающих все предыдущие этапы анализа.

*Подблок 10.1.: Настройка окружения (Импорт `matplotlib.pyplot` и `seaborn`, установка стиля (`seaborn-v0_8-darkgrid`), палитры и размеров фигур, создание папки `visualizations`)*

*Подблок 10.2.: Генерация графиков*

  - Распределение продаж: Гистограмма продаж (лог-шкала), боксплот по годам, топ-10 товаров, pie-диаграмма по категориям магазинов.
  - Анализ OOS: Топ товаров и топ магазинов по риску дефицита.
  - Анализ Overstock: Распределение дней запаса, топ товаров-излишков, pie-диаграмма доли overstock товаров.
  - Анализ сезонности: Динамика продаж по неделям, сравнение праздничных/обычных недель, топ типов сезона.
  - ABC-XYZ: Парето-диаграмма, матрица ABC-XYZ (тепловая карта), распределение по ключевым группам.
  - Корреляции: Матрица корреляции продаж/остатков/заказов, диаграммы рассеяния, анализ продаж по кластерам.
...
*Подблок 11.1.: Создание таблицы норм отгрузки на 2026 год*

*Подблок 11.2.: Расчет базовых норм по товарам и магазинам*

*Подблок 11.3.: Расчет коэффициентов для 2026 года (Коэффициент роста (сравнение 2025 vs 2024), коэффициент сезонности (праздники), Коэффициент для OOS-товаров)*

*Подблок 11.4.: Расчет финальных норм (Базовая недельная норма = Средние продажи × Коэффициент роста)*

*Подблок 11.5.: Интеграция с ABC-XYZ анализом - Присоединение (merge) результатов ABC-XYZ анализа к таблице норм*

*Подблок 11.6.: Добавление информации OOS и Overstock*

*Подблок 11.7.: Добавление сезонных меток*

*Подблок 11.8.: Создание финальной таблицы норм*

*Подблок 11.9.: Сохранение результатов*

*Подблок 11.10.: Примеры норм для ключевых товаров*

Выводы по этапу:

  - Инсайт 1: Тренд негативный - Продажи 2024: 883 878 шт., Продажи 2025: 761 572 шт. Падение продаж в 1-м квартале 2025 года по сравнению с 1-м кварталом 2024 составило -14%. Коэффициент роста 0.86.
  - Инсайт 2: Средние нормы очень низкие. Средняя базовая норма по всем товарам и магазинам составляет 1.6 шт./неделю.
